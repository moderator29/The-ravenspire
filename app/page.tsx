...
export default function Landing() {
  ...
  /* The realm has not run a competitive Season yet, so a badge reading
     "Season I" claimed a ladder that does not exist. "Season 0" is the
     honest name for where the realm actually stands: forged, open, and one
     step ahead of its first real Season. This is a lifecycle label, distinct
     from the Season Zero founding round (lib/season-zero.ts), which is a
     separate, currently sealed mechanic; naming this era after it is not a
     claim that the round itself is open, see rule 7. */
  const heroBadge = "Season 0 · The realm awakens";
