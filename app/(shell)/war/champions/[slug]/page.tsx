...
import { ChampionStats } from "@/components/war/war-chrome";
        ...
        <Card pad="none" className="overflow-hidden">
          <div className="flex flex-col sm:flex-row">
            ...
            <div className="min-w-0 flex-1 p-4 sm:p-5">
              ...
              <p className={`mt-2 text-bone-faint ${BOARD_META}`}>
        ...
        <Tabs defaultValue="stats">
          ...
          <TabsPanel value="stats" className="pt-4">
            <Card>
              ...
              <p className={`mt-4 text-bone-faint ${BOARD_META}`}>
  ...
  return (
    <Card>
      <div className="flex items-center gap-2">
        ...
        <span
          className={`uppercase tracking-[0.16em] text-bone-faint ${BOARD_META}`}
        >
          {kind}
        </span>
      </div>
