...
import { ArtTile, ChampionStats } from "@/components/war/war-chrome";
...
/* Choosing a champion and a ground.
   ...
   Archetype: BoardList, twice. Both halves of this page are a set of options being
   compared before one is picked, which is exactly what a BoardList is for, so the
    ...
    <BoardPage width="wide">
      <BoardStack>
        ...
        {showSkeleton ? (
          ...
          <>
            <BoardList label="Champions ready to march">
              {roster.map((c) => {
                    ...
                    >
                      ...
                      <span className="min-w-0 flex-1">
                        <span className="flex items-center gap-2">
                          <span
                            className={`truncate font-semibold text-bone ${BOARD_BODY}`}
                          >
                            {c.name}
                          </span>
            ...
            <Card>
              ...
              <p className={`mt-0.5 text-bone-faint ${BOARD_META}`}>
