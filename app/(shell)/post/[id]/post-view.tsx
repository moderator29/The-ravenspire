...
/* A raven and its thread, on the Dossier archetype.
   ...
   The route itself is a server component now, so the raven can be read once on
   the server for the share card's title and description. This is the client
   half of it: the id arrives as a plain prop rather than a promise. */
