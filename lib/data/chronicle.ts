...
export const chronicle: ChronicleSection[] = [
...

  {
    ...
    body: [
      ...
      "The realm's token is $RSP, with a total supply of one billion, matching the standard Pump.fun launch model. Points convert to $RSP at the token generation event. Season Zero, the founding round, is currently archived; it has its own section below, and any later sale phases will be announced before they run.",
